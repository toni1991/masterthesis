...
\end{itemize}
Der Aufruf einer Funktion erfolgt wie in Zeile 12 gezeigt mittels Methodenname und den zu übergebenen Parametern. Außerdem zeigt sich, dass Funktionen mithilfe des \mintinline{java}{return}-Statements \textbf{einen} Rückgabewert an die aufrufende Funktion zurückgeben können. Ein \mintinline{java}{return} kann auch dazu benutzt werden um Funktionen an anderen Stellen als der letzten Zeile zu verlassen. Eine Funktion ohne Rückgabewert -- \mintinline{java}{void} -- terminiert implizit in der letzten Zeile und benötigt kein explizites \mintinline{java}{return}, kann dieses jedoch auch ohne Rückgabewert nutzen um vorher den Funktionsablauf zu beenden. Eine Methode mit Rückgabewert muss stets einen Wert mit passendem Datentyp durch \mintinline{java}{return} zurückgeben.
