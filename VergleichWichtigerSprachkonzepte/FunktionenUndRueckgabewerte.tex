...
\begin{itemize}
    ...
    Wie gezeigt erhalten die Funktionen unterschiedliche Parameter. Die Methode \jav{process()} zum Beipiel erhält keinen Parameter. \jav{getGreeting(String, String)} erwartet hingegen   zwei Parameter vom Typ \jav{String}.
