...
\input{Bilder/JavaStructureTikz}
...
\subsection*{COBOL}
\todo{Get coloring eye friendly}
{

\begin{wrapfigure}{l}{.5\textwidth}
\centering
\input{Bilder/CobolStructureTikz}
...
\TODO{DIVISIONS, SECTIONS, PARAGRAPHS, SENTENCES, STATEMENTS -> TERMINATED WITH DOT.}

}

\todo{Einteilung einer Zeile. Erste X Zeichen reserviert usw. 80 Zeichen länge....}

\todo{Variablen sind immer global in COBOL}