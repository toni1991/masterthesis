...
So kann man den Namen einer \textit{SECTION} oder eines Paragraph mit einem Präfix versehen und die darin genutzten Variablen mit demselbigen kennzeichnen. Beispielsweise sollte eine Variable \mintinline{cobolfree}{PC-100-VALUE} nur in der \textit{SECTION} \mintinline{cobolfree}{PC-100-PROCESS} verwendet werden. 
