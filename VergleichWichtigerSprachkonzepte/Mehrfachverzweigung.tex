...
Auch hier sieht man in den Zeilen 12, 15, 18 und 21 ein gewolltes \quotes{Durchfallen} wie in Java. Einziger Unterschied hierbei ist, dass in COBOL jeder ausführbare Block nach einem \cob{WHEN} eigenständig und somit kein \jav{break} notwendig ist. Ein \quotes{Durchfallen} ist nur möglich, wenn der komplette Anweisungsblock leer ist. 
