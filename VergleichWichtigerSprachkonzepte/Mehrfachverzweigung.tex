...
Eine weitere Eigenheit zeigt sich in der Auswertung der Variable \mintinline{text}{AGE}. Hierbei werden im Beispiel Wertebereiche angegeben, in denen die Variable liegen kann. Auch das ist in Java so nicht möglich, da wie bereits erwähnt nur mit Literalen und Konstanten verglichen werden kann.
