...
Die \cob{ENVIRONMENT DIVISION} kann eine \cob{INPUT-OUTPUT SECTION} und eine \cob{CONFIGURATION SECTION} enthalten. Erstere beinhaltet Definitionen zum Dateizugriff sowie zu Ein- und Ausgabeoperationen und letztere zum Zielsystem.
