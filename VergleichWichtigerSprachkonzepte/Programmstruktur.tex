\section{Programmstruktur}\mylabel{sec:structure}
...
\begin{figure}[H]
    ...
    \caption{Strukturelle Bestandteile eines Java-Programms \mylabel{javaStructureDiagram}}
\end{figure}
...
\subsection*{Struktur eines COBOL-Programms}\mylabel{cobolstructure}

\begin{figure}[H]
    \centering
    \resizebox{.9\linewidth}{!}{\input{Bilder/CobolStructureTikz.tikz}\unskip}
    \caption{Strukturelle Bestandteile eines COBOL-Programms \mylabel{cobolStructureDiagram}}
\end{figure}
