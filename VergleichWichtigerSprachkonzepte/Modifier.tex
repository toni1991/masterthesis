...
\jav{protected} beschränkt den Zugriff auf die enthaltende Klasse (mitsamt geschachtelter Klassen) und alle Unterklassen. Erbt eine Klasse eine solche Methode oder Variable, kann sie diese nutzen. Andere Klassen haben keinen Zugriff darauf.
