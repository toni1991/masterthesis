...
Da Daten in COBOL häufig als Array vorliegen lassen sich Beziehungen hier über die Speicherung von Indizes erreicht werden. Dies zeigt \autoref{assocCobol} für das Beispiel verheirateter Personen. Um mehrfache Beziehungen herzustellen kann, statt einem Index, ein Array von Indizes gespeichert werden. 

\mintedCobol{Entities.cbl}{Assoziationen in COBOL}{assocCobol}